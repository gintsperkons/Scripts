...
def parse():
    ...
    clean_parser_all = subparsers.add_parser("clean:all", help="clean all project files")
    ...
    exec_parser.add_argument('function', nargs='?', default=None, help="Name of the custom script to execute")
